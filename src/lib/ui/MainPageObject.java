...
public class MainPageObject {
    ...
    public WebElement checkText(String locator, String error_message, long timeoutInSeconds, String message, String expected){
        WebElement element = waitForElementPresent(locator, error_message, timeoutInSeconds);
    ...
    public WebElement checkWordInSearchResult(String locator, String error_message, long timeoutInSeconds){
        WebElement element = waitForElementPresent(locator, error_message, timeoutInSeconds);
        String search_title = element.getAttribute("text");

...
public class MainPageObject {
    ...
    public WebElement checkText(By by, String error_message, long timeoutInSeconds, String message, String expected){
        WebElement element = waitForElementPresent(by, error_message, timeoutInSeconds);
    ...
    public WebElement checkWordInSearchResult(By by, String error_message, long timeoutInSeconds){
        WebElement element = waitForElementPresent(by, error_message, timeoutInSeconds);
        String search_title = element.getAttribute("text");
